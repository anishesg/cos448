...
function SequenceEditor({ campaign, onClose }: SequenceEditorProps) {
      ...
      <div style={{ flex: 1, overflow: "auto" }}>
        ...
        <div className="v3-page-header" style={{ position: "static" }}>
          ...
          <div className="v3-page-header-right">
            <button className="v3-btn-secondary" style={{ fontSize: 12 }}>Enable sequence</button>
          ...
          <div className="v3-sequence-step">
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 13 }}>
                ...
                <strong>Step 1</strong> Automated email
              </div>
